...
class AppColors {
  ...
  // ignore: non_constant_identifier_names
  static final MaterialColor SHADOW_BLUE = _factoryColor(0xFF89C5E6);

  //clipper 2
  // ignore: non_constant_identifier_names
  static final MaterialColor SHADOW_RED = _factoryColor(0xFFFF3a5a);

  // ignore: non_constant_identifier_names
  static final MaterialColor SHADOW_RED1 = _factoryColor(0xFFA50034);

 //clipper 3
  // ignore: non_constant_identifier_names
  static final MaterialColor SHADOW_RED2 = _factoryColor(0xFFFDB0C7);

  //clipper 1
   // ignore: non_constant_identifier_names
   static final MaterialColor SHADOW_RED3 = _factoryColor(0xFFDB98AC);
